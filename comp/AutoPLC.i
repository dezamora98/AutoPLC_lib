...
TXSTAbits.SYNC = 0;
TXSTAbits.BRGH = 0;
SPBRG = (uint8_t)((((48000000/9600)/16)-1) & 0x00FF);
SPBRGH = (uint8_t)((((48000000/9600)/16)-1) >> 8);
...
if (i & 0x10) LATCbits.LATC1 = 0;
else LATCbits.LATC0 = 0;

SSPBUF = (A_pack) >> 8;
while (!SSPIF);
SSPIF = 0;
SSPBUF = (A_pack & 0x00FF);
while (!SSPIF);
SSPIF = 0;

if (i & 0x10) LATCbits.LATC1 = 1;
