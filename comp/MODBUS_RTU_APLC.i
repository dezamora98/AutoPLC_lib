...
# 77
extern uint8_t DOUT __at((((((((0x200-16)-8)-2)-2)-2)-1)-1));
typedef struct
{
uint8_t DI1:1;
uint8_t DI2:1;
...
extern volatile DOUTbits_t DOUTbits __at((((((((0x200-16)-8)-2)-2)-2)-1)-1));

extern uint8_t DIN __at(((((((((0x200-16)-8)-2)-2)-2)-1)-1)-1));
typedef struct
{
uint8_t DO1:1;
uint8_t DO2:1;
...
extern volatile DINbits_t DINbits __at(((((((((0x200-16)-8)-2)-2)-2)-1)-1)-1));

void REF_DIO(void);


extern uint8_t SAIN __at(((((((0x200-16)-8)-2)-2)-2)-1));
typedef struct
{
uint8_t SAI1:1;
uint8_t SAI2:1;
...
extern volatile SAINbits_t SAINbits __at(((((((0x200-16)-8)-2)-2)-2)-1));

void REF_SAIN(void);

# 129
extern uint8_t AIN[16] __at((0x200-16));
typedef struct
{
uint8_t AL1:8;
uint8_t AH1:8;
...
extern volatile AINreg_t AINreg __at((0x200-16));


extern uint16_t EAIN __at((((0x200-16)-8)-2));
typedef struct
{
uint8_t EAI1:1;
uint8_t EAI2:1;
...
extern volatile EAINbits_t EAINbits __at((((0x200-16)-8)-2));

void ADIN(void);

# 173
extern uint16_t AOUT[4] __at(((0x200-16)-8));
typedef struct
{
uint8_t AO1:16;
uint8_t AO2:16;
...
extern volatile AOUTreg_t AOUTreg __at(((0x200-16)-8));
...
# 26 "MODBUS_RTU_APLC.h"
extern uint8_t M_ADU[20] __at(0x20);
...
T0CON = 0b00000111;
INTCONbits.TMR0IF = 0;
TMR0L = (uint8_t)((0x10000 - ( 500 * 48000000/1024000))&0x00FF);
TMR0H = (uint8_t)((0x10000 - ( 500 * 48000000/1024000))>>8);
T0CONbits.TMR0ON = 1;
...
while(INTCONbits.TMR0IF == 0 && i < 20)
{
...
PIR1bits.RCIF = 0;
INTCONbits.TMR0IF = 0;
TMR0L = (uint8_t)((0x10000 - ( (11/9600)*3500 * 48000000/1024000))&0x00FF);
TMR0H = (uint8_t)((0x10000 - ( (11/9600)*3500 * 48000000/1024000))>>8);
}
}
...
CRC_s = CRC_calc(C_byte-2);

if(CRC_s != ( (M_ADU[C_byte-1] <<8) | (M_ADU[C_byte-2]) ) )
{
return 0x0100;
}
if( M_ADU[0] != slave || M_ADU[1] == FC )
{
return 0x0200;
}
if(FC == 0x05 || FC == 0x06)
...
for(i = 0; i < size ;++i)
{
CRC = (CRC & 0xFF00) | ( (CRC ^ M_ADU[i]) & 0x00FF);
for(j = 0; j<8; ++j)
{
if(CRC & 0x0001)
{
